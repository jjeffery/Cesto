...
namespace Cesto.Tests
{
	...
	public class EntityBaseTests
	{
		...
		public class EntityWhoseIdCanChange : EntityBase<EntityWhoseIdCanChange, int>
		{
			public int Id;
		...
		public class Int32Entity : EntityBase<Int32Entity, int>
		{
		...
		public class Int64Entity : EntityBase<Int64Entity, long>
		{
		...
		public class StringEntity : EntityBase<StringEntity, string>
		{
		...
		public class EnumEntity : EntityBase<EnumEntity, EnumType>
		{
		...
		public class GuidEntity : EntityBase<GuidEntity, Guid>
		{
