...
namespace Cesto
{
    ...
    /// These semantics are also used by Entity Framework V5 and later.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public abstract class OrmEntity<TEntity, TId> : IEquatable<TEntity>, IComparable<TEntity>
        where TEntity : OrmEntity<TEntity, TId>
...
#pragma warning restore 649
        ...
        static OrmEntity()
        {
            if (IdHelper == null)
            {
                var type = typeof (OrmEntity<TEntity, TId>);
                var field = type.GetField("IdHelper",
                ...
                else
                {
                    ...
                    var genericType = helperType.MakeGenericType(typeof (TId));
                    var helper = Activator.CreateInstance(genericType, null);
                    field.SetValue(null, helper);
                }
            }
        ...
        protected OrmEntity()
        {
            if (IdHelper == null)
            {
                ...
                throw new NotImplementedException(
                    "Static field IdHelper is null. This indicates an internal software error.");
            }
        }
        ...
        /// Equality operator
        /// </summary>
        public static bool operator ==(TEntity entity1, OrmEntity<TEntity, TId> entity2)
        {
