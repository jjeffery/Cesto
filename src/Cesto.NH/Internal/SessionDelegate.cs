...
namespace Quokka.NH.Implementations
{
	...
	public class SessionDelegate : MarshalByRefObject, ISession
	{
		...
		private TransactionDelegate _transaction;
		...
		{
			get { return _inner.DefaultReadOnly; }
		...
		public ITransaction Transaction
		{
			get
			{
				...
				{
					_transaction = new TransactionDelegate(_inner);
					_transaction.TransactionCompleted += AfterTransactionCompleted;
				}
				return _transaction;
			}
		}

		private void AfterTransactionCompleted(TransactionDelegate transaction)
		{
			transaction.TransactionCompleted -= AfterTransactionCompleted;
